...
<tr>
    ...
    <td>{{ $rows->nohp }}</td>
    <td>
        <a href="{{ asset('peminjam/edit/'.$rows->id_peminjam ) }}"><span class="badge badge-warning">Edit</span></a>
        <a href="{{ url('peminjam/delete/'.$rows->id_peminjam ) }}"><span class="right badge badge-danger">Del</span></a>
</td>
</tr>
<?php 
}
